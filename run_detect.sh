...
python3 detect.py --cfg yolov3-spp-rbox.cfg --weights weights/last_KoPER.pt --names data/bev_network.names --save-txt --conf-thres 0.5 --iou-thres 0.2 --single-cls --rotated --rotated-anchor --img-size 544 \
